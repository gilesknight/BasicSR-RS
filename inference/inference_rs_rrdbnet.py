...
def main():
    ...
    parser.add_argument('--input', type=str, default='datasets/PS_NM_timeseries/dam_114567/inputs', help='input test image folder')
    parser.add_argument('--output', type=str, default='results/PS_NM_timeseries/dam_114567/ESRGAN', help='output folder')
