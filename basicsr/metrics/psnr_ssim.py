...
def calculate_psnr_rs(img, img2, crop_border, max_pixel, input_order='HWC', test_y_channel=False, **kwargs):
    ...
    if mse == 0:
        return float('inf')
    return 10. * np.log10(float(max_pixel) * float(max_pixel) / mse)
